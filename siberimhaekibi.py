...
def usage():
	print '---------------------------------------------------'
	print 'Siber İmha Ekibi DDOS Saldırı Aracı'
	print 'İyi Kullanımlar Dilerim'
        print 'Turkısh Cyber Army'
	print '---------------------------------------------------'
	...
	def run(self):
		...
		while flag==0:
			if (previous+100<request_counter) & (previous<>request_counter):
				print "%d Paket Gönderildi" % (request_counter)
				previous=request_counter
		if flag==2:
			print "\n-- Site Kasiyo... '-' --"
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "Siber İmha Ekibi DDOS Aracı"
		print "TURKISH CYBER ARMY"
		print "---- DDOS Saldırısı Başladı! ----"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
